...
def agrupa_id_gestor(df_gestao):
    ...
    gestores['id_gestor'] = []
    gestores['n_atuacoes'] = []
    #gestores['nota_var'] = [] - descomentar se for usar o IDESP
...
def etl_nota_sar():
    df_gestao = etl_gestores.etl()
    df_gestao_nota = adiciona_saresp(df_gestao)
    return df_gestao_nota

def adiciona_saresp(df_gestao):
    df_idesp = etl_saresp.etl()
